...
class FilesFormatPageLocators:
    ...
    AVI_FILE_CREATED = (By.XPATH, "(//p[text()='avi.avi'])[1]")
    # SORT_BY_POPULAR = (By.CSS_SELECTOR, "button[class='m-ui-button-text content-layout__sorted'] span[class='m-ui-typography m-ui-typography--bold m-ui-typography--14x14 m-ui-button-text__label']")
    SORT_BY_POPULAR = (By.XPATH, "//span[contains(text(),'по популярности')]")
