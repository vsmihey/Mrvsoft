...
class CreateTopicDatabaseLocators:
    ...
    NAME_OF_ARTICLE = (By.XPATH, "//input[@class='m-ui-text-input__input']")
    ...
    TEXT_CHOOSE_QUESTION_FOR_TEST = (By.XPATH, "//h3[text()='Выберите вопросы для теста']")
    ...
    INPUT_NAME_CONTENT = (By.XPATH, "//input[@class='m-ui-text-input__input']")
    ...
    DIRECT_FOLDER_NAME = (By.XPATH, "//select[@class='m-ui-select__select']")
